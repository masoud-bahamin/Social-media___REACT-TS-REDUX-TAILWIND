...
export default function Profile() {
    ...
    const { userInfo, loading, status, error } = useSelector((state: StateType) => state.Users)
                            ...
                            <div className="relative flex flex-col min-w-0 break-words bg-white dark:text-gray-200 dark:bg-gray-600 w-full mb-6 shadow-xl rounded-lg -mt-64">
                                <div className="px-6">
                                        ...
                                        <div className="w-full lg:w-4/12 px-4 lg:order-1">
                                            <div className="flex justify-center py-4 lg:pt-4 pt-8">
                                                <div className="mr-4 p-3 text-center">
                                                    ...
                                                    <span className="text-sm text-gray-400 dark:text-gray-300">Friends</span>
                                                </div>
                                                <div className="mr-4 p-3 text-center">
                                                    <span className="text-xl font-bold block uppercase tracking-wide text-gray-600 dark:text-gray-200">
                                                        {userInfo?.posts.length}
                                                    </span>
                                                    <span className="text-sm text-gray-400 dark:text-gray-300">Photos</span>
                                                </div>
                                                <div className="lg:mr-4 p-3 text-center">
                                                    <span className="text-xl font-bold block uppercase tracking-wide text-gray-600 dark:text-gray-200">
                                                        14
                                                    </span>
                                                    <span className="text-sm text-gray-400 dark:text-gray-300">Comments</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text-center mt-12">
                                        ...
                                        <div className="text-sm leading-normal mt-0 mb-2 text-gray-400 dark:text-gray-300 font-bold uppercase">
